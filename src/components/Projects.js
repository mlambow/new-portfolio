    ...
    <div className='relative flex h-screen overflow-hidden flex-col text-left md:flex-row max-w-full justify-evenly mx-auto items-center z-0'>
      ...
      <div className='flex w-full space-x-5 overflow-x-scroll p-10 snap-x snap-mandatory scrollbar-thin scrollbar-thumb-[#e4c359]/60 absolute z-10 scrollbar-corner-[#e4c359]/60'>
        ...
        <ExperienceCard
          ...
          src5='https://shorturl.at/flnE0'
          listItem1='This is the first clone I have built'
          listItem2='In this clone you are able to view all the latest, now playing and trending movies'
          listItem3='Not only that you can see the movies but you can also be able to view the trailers only by a click on the movie poster'
        ...
        <ExperienceCard 
          ...
          src4='https://shorturl.at/mNTY9'
          src5='https://shorturl.at/flnE0'
          listItem1='This is a weather app that shows you the weather of your location'
          ...
          listItem4='Its a must check app'
          url='weather-app'
        ...
        <ExperienceCard
          ...
          src5='https://shorturl.at/flnE0'
          listItem1='This is an Amazon Clone where you are able to buy your favourite products'
        ...
        <ExperienceCard 
          ...
          src4='https://shorturl.at/tzORU'
          src5='https://shorturl.at/flnE0'
          listItem1='This is a banking landing page'
